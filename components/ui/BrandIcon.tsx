import type { ChannelIcon } from "@/lib/site";

/**
 * Monochrome brand marks. lucide-react v1 removed its brand icons, so the
 * GitHub and LinkedIn glyphs are inlined here; `mail` uses a plain envelope
 * drawn in the same weight so the row stays visually consistent.
 */
const PATHS: Record<ChannelIcon, { viewBox: string; d: string; filled: boolean }> = {
  github: {
    viewBox: "0 0 16 16",
    filled: true,
  ...
  mail: {
    viewBox: "0 0 24 24",
    filled: false,
    d: "M3 6.5h18v11H3z M3 7l9 6.5L21 7",
  },
};
